...
{
    /**
     * @Route("/reservation2/{type}/{pax}/{destination}", name="reservation_specific")
     */
    public function specificAction($type, $pax, $destination)
    {
        // replace this example code with whatever you need
        return $this->render(':Reservation:specific.html.twig', array(
        ));
    }
    ...
    public function newAction()
    {
        ...
        return $this->render(':Reservation:new.html.twig', array(
            ...
            'prices' => json_encode($this->getDoctrine()->getRepository('AppBundle:Transfer')->getActivePrices())
        ));
    }
     ...
     *
     * @Route("/{id}/show", name="reservation_show")
     * @Method("GET")
     * @Template()
     */
